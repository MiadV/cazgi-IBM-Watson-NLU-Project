...
app.get("/url/emotion", (req, res) => {
    ...
    naturalLanguageUnderstanding.analyze(analyzeParams)
        .then(analysisResults => {
            ...
            /**
             * in real world scenario this sentiment array might be empty and we have to handle that as well. 
             * I'm not doing it here because its not included in the requirements.
             */
